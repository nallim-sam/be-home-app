...
public class ListaCompraManager {
    ...
    private static final String DELETE_LISTA_PRODUCTO_QUERY = "DELETE FROM Lista_Producto WHERE id_lista = ?";
    private static final String DELETE_PRODUCTOS_QUERY= "DELETE FROM Producto WHERE id IN (SELECT id_producto FROM Lista_Producto WHERE id_lista = ?)";
    private static final String DELETE_LISTA_QUERY = "DELETE FROM Lista WHERE id = ?";
